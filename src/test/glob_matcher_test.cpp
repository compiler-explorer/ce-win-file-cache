...
TEST_CASE("GlobMatcher absolute and non-relative paths", "[glob]")
{
    ...
    SECTION("UNC network paths")
    {
        ...
        REQUIRE(GlobMatcher::matches(L"\\\\127.0.0.1\\efs\\compilers\\msvc\\bin\\cl.exe", L"\\\\127.0.0.1\\efs\\**\\*.exe"));
...
TEST_CASE("GlobMatcher complex patterns", "[glob]")
{
    ...
    SECTION("Real compiler paths from network shares")
    {
        ...
        REQUIRE(GlobMatcher::matches(L"\\\\127.0.0.1\\efs\\compilers\\msvc\\14.40.33807-14.40.33811.0\\bin\\Hostx64\\x64\\cl.exe", 
                                    L"\\\\127.0.0.1\\efs\\compilers\\msvc\\**\\bin\\**\\*.exe"));
        REQUIRE(GlobMatcher::matches(L"\\\\127.0.0.1\\efs\\compilers\\windows-kits-10\\Include\\10.0.22621.0\\ucrt\\stdio.h",
