...
int main()
{
    ...
    try 
    {
        ...
        NTSTATUS status = download_manager.queueDownload(
            L"/test", L"/nonexistent", nullptr, CachePolicy::ALWAYS_CACHE,
    ...
    try 
    {
        ...
        download_manager.queueDownload(
            L"/test", L"large_thread_test.txt", nullptr, CachePolicy::ALWAYS_CACHE,
    ...
    try 
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            download_manager.queueDownload(
                path, L"rapid_test.txt", nullptr, CachePolicy::ALWAYS_CACHE,
    ...
    try 
    {
        ...
        
        {
            ...
            {
                download_manager.queueDownload(
                    L"/shutdown/" + std::to_wstring(i), L"/nonexistent", nullptr, 
