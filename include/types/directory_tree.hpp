...
public:
    ...
    bool addFile(const std::wstring& virtual_path, const std::wstring& network_path, 
                 UINT64 size = 0, const FILETIME* creation_time = nullptr);
...
private:
    ...
    void updateNodeMetadata(DirectoryNode* node, const std::wstring& network_path, 
